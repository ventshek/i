...
Install widgets = tiled menu by chris && menu z && Win7 Volume Mixer


Step by step 
1. Install Tiled menu && win7 volume  and add config, 
https://github.com/ventshek/i/blob/main/TiledMenuConf.sh
